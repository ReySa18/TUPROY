...
public class PipeControl {
    ...
    public void draw(Graphics g,Bird bird){
        ...
        try {
            File soundFile = new File("src\\main\\resources\\music\\hit.wav");
    ...
    * */
    ...
    private void playGameOverSound() {
        if (!gameOverSoundPlayed && gameOverSound != null && !gameOverSound.isRunning()) {
            gameOverSound.setFramePosition(0);
            gameOverSound.start();
            gameOverSoundPlayed = true; // Set the flag to true to indicate that the game over sound has been played
        }
    }
